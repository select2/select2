...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.Select2 = factory(root.jQuery);
    }
    ...
    nextUid = (function () { 
        var counter=1; return function () { return counter++; }; 
    }());
    ...
    function installFilteredMouseMove(element) {
      element.bind("mousemove", function (e) {
          ...
          if (lastpos === undefined || lastpos.x !== e.pageX || 
              lastpos.y !== e.pageY) {
    ...
    function measureTextWidth(e) {
        if (!sizer) {
            var style = e[0].currentStyle || 
                    window.getComputedStyle(e[0], null);
    ...
    // TODO javadoc
    function tags(data) {
        // TODO even for a function we should probably return a wrapper that
        // does the same object/string check as the function for arrays.
        // otherwise only functions that return objects are supported.
        if ($.isFunction(data)) {
            return data;
        }
...
*/
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            this.containerSelector = "#" + this.containerId.replace(
                /([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g, 
                '\\$1'
            );
            ...
            if (opts.element.attr("class") !== undefined) {
                this.container.addClass(opts.element.attr("class").replace(
                    /validate\[[\S ]+] ?/, 
                    ''
                ));
            }
            ...
            this.opts.element.data("select2", this).hide().
            ...
            this.dropdown.delegate(resultsSelector, "mouseup", this.bind(
                function (e) {
            ...
            // may be a modal that is listening for mouse events outside of
            // itself so it can close itself. since the dropdown is now outside
            // the select2's dom it will trigger the popup close, which is not
            // what we want
            ...
            if (opts.element.is(":disabled") || 
                opts.element.is("[readonly='readonly']")) this.disable();
        },
        ...
        destroy: function () {
            ...
            if (select2 !== undefined) {
                ...
                select2.opts.element.removeData("select2").unbind(".select2").
                    show();
            }
        },
        ...
        prepareOpts: function (opts) {
            ...
            opts = $.extend({}, {
                ...
                populateResults: function (container, results, query) {
                    ...
                    populate = function (results, container, depth) {
                        var i, l, result, selectable, compound, node, label, 
                            innerContainer, formatted;
            ...
            if (select) {
                opts.query = this.bind(function (query) {
                    var children, firstChild, process,
        ...
        positionDropdown: function () {
            var offset = this.container.offset(),
                ...
                viewPortRight = $(window).scrollLeft() + 
       ...
       dropLeft = offset.left + width - dropWidth;
        ...
        highlight: function (index) {
            ...
            if (arguments.length === 0) {
                return indexOf(choices.filter(".select2-highlighted")[0], 
                               choices.get());
            }
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                if (this.opened()) {
                    ...
                    if (e.which === KEY.TAB || KEY.isControl(e) || 
                        KEY.isFunctionKey(e) || e.which === KEY.ESC) return;

                    if (this.opts.openOnEnter === false && 
                        e.which === KEY.ENTER) return;
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        initContainer: function () {
            ...
            this.search.bind("keydown", this.bind(function (e) {
                ...
                if (e.which === KEY.TAB || KEY.isControl(e) || 
                    KEY.isFunctionKey(e) || e.which === KEY.BACKSPACE || 
                    e.which === KEY.ESC) return;
        ...
        tokenize: function () {
            ...
            input = this.opts.tokenizer(input, this.data(), 
    ...
    $.fn.select2 = function () {
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["val", "destroy", "opened", 
                "open", "close", "focus", "isFocused", "container", 
                "onSortStart", "onSortEnd", "enable", "disable", 
