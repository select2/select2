...
QUnit.test(
  'mouseenter clears aria-selected on all highlighted results',
  function (assert) {
    assert.expect(4);
    ...
    var $options = results.$results.find(
    ...
    assert.notOk(
      $options.eq(0).hasClass('select2-results__option--highlighted'),
    ...
    assert.notOk(
      $options.eq(1).hasClass('select2-results__option--highlighted'),
...
QUnit.test(
  'tag result is highlighted with no other selections',
  function (assert) {
    assert.expect(2);
...
QUnit.test(
  'tag result is highlighted with other selections',
  function (assert) {
    assert.expect(2);
