...
test('appends to the dropdown parent with data attribute', function (assert) {
    assert.expect(4);

    var $ = require('jquery');

    var $select = $('<select data-dropdown-parent="#parent"></select>');
    ...
    var dropdown = new DropdownAdapter($select, new Options({}, $select));
