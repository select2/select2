...
<button aria-label="Set Select2 option" class="js-programmatic-set-val button">
 Set "California"
</button>
...
<p>
 <select class="js-example-programmatic js-states form-control" id="select2-single">
 </select>
</p>
<label for="select2-multi">
 Multiple select
</label>
<button aria-label="Programmatically set Select2 options" class="js-programmatic-multi-set-val button" type="button">
 Set to California and Alabama
</button>
<button aria-label="Programmatically clear Select2 options" class="js-programmatic-multi-clear button" type="button">
 Clear
</button>
<p>
 <select class="js-example-programmatic-multi js-states form-control" id="select2-multi" multiple="multiple">
 </select>
</p>
```
