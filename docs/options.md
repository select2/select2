...
> [!NOTE]
> Options sourced from [other data sources](data-sources/ajax.md) must conform to this this same internal representation. See ["The Select2 data format"](data-sources/formats.md) for details.
