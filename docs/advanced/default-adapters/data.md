...
This decorator implements the [tagging](../../tagging.md) feature.
...
This decorator implements the [minimum search term length](../../searching.md#minimum-search-term-length) feature as exposed through the `minimumInputLength` configuration option.
...
This decorator implements the [maximum search term length](../../searching.md#maximum-search-term-length) feature as exposed through the `maximumInputLength` configuration option.
